...
public class EmotionHorizontalScrollView extends HorizontalScrollView {
    private final static String TAG = "CusHorizontalScrollView";

    public EmotionHorizontalScrollView(Context context) {
        super(context);
    }

    public EmotionHorizontalScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public EmotionHorizontalScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
