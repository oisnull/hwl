...
//
//public class EmotionIndicatorViewV3 extends LinearLayout {
//
...
//
//    public EmotionIndicatorViewV3(Context context, AttributeSet attrs) {
//        super(context, attrs);
//        this.mContext = context;
//        this.setOrientation(HORIZONTAL);
//
//        TypedArray a = context.getTheme().obtainStyledAttributes(attrs,
//                R.styleable.EmotionIndicatorViewV3, 0, 0);
//
//        try {
//            mDrawableSelect = a.getDrawable(R.styleable.EmotionIndicatorViewV3_bmpSelect);
//            mDrawableNomal = a.getDrawable(R.styleable.EmotionIndicatorViewV3_bmpNormal);
//        } finally {
//            a.recycle();
//        }
//
