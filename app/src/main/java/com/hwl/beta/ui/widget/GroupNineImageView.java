...
public class GroupNineImageView extends ViewGroup {
    ...
    public GroupNineImageView(Context context) {
        this(context, null);
    }

    public GroupNineImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GroupNineImageView(Context context, AttributeSet attrs, int defStyleAttr) {
