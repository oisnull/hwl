...
public class NearCircleOperateMessageListen extends
	...
	private void addComment(){
       ...
       NearCircleComment commentInfo = DaoUtils.getNearCircleManagerInstance().getComment(messageContent.getNearCircleId(),
	...
	private void cancelComment(){
		...
		DaoUtils.getNearCircleManagerInstance().deleteComment(messageContent.getNearCircleId(), messageContent.getPostUser().getUserId(), messageContent.getCommentId());
	...
	private void addLike(){
       ...
       NearCircleLike likeInfo = DaoUtils.getNearCircleManagerInstance().getLike(messageContent.getNearCircleId(),messageContent.getPostUser().getUserId());
