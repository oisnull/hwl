...
public class CharacterParser {
    ...
    public String getFirstLetter(String nameOrRemark) {
        if (StringUtils.isBlank(nameOrRemark)) {
            return "#";
        } else {
            String pinyin = this.getSelling(nameOrRemark).substring(0, 1).toUpperCase();
            // 正则表达式，判断首字母是否是英文字母
