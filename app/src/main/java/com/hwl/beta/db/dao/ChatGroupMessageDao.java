...
public class ChatGroupMessageDao extends AbstractDao<ChatGroupMessage, Long> {
    ...
    public static class Properties {
        ...
        public final static Property StatusDesc = new Property(17, String.class, "statusDesc", false, "STATUS_DESC");
        public final static Property SendTime = new Property(18, java.util.Date.class, "sendTime", false, "SEND_TIME");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CHAT_GROUP_MESSAGE\" (" + //
                ...
                "\"STATUS_DESC\" TEXT," + // 17: statusDesc
                "\"SEND_TIME\" INTEGER);"); // 18: sendTime
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, ChatGroupMessage entity) {
        ...
        if (statusDesc != null) {
            stmt.bindString(18, statusDesc);
        }
 
        java.util.Date sendTime = entity.getSendTime();
        if (sendTime != null) {
            stmt.bindLong(19, sendTime.getTime());
        }
    }
    ...
    public ChatGroupMessage readEntity(Cursor cursor, int offset) {
        ChatGroupMessage entity = new ChatGroupMessage( //
            ...
            cursor.isNull(offset + 17) ? null : cursor.getString(offset + 17), // statusDesc
            cursor.isNull(offset + 18) ? null : new java.util.Date(cursor.getLong(offset + 18)) // sendTime
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, ChatGroupMessage entity, int offset) {
        ...
        entity.setStatusDesc(cursor.isNull(offset + 17) ? null : cursor.getString(offset + 17));
        entity.setSendTime(cursor.isNull(offset + 18) ? null : new java.util.Date(cursor.getLong(offset + 18)));
     }
